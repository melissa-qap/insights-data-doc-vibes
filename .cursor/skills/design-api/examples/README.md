...
| Investment account | [investment-account/investment-account-apis.md](investment-account/investment-account-apis.md) | `POST /v1/plaid/sync/balances` (cross-ref), `POST /v1/plaid/sync/investment-holdings`, `GET /v1/investment/holdings`, `GET /v1/investment/allocation`; reuses `GET /v1/account-balance`, `GET /v1/performance-history` |
